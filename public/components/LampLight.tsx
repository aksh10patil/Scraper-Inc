...
export function LampDemo() {
  ...
  className="mt-8 bg-gradient-to-br rounded-2xl  from-purple-300 to-purple-500 py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-white md:text-7xl"
>
  Build Tech for Your Business <br /> the right way
</motion.h1>
...
<motion.p
  ...
  className="mt-4 max-w-2xl text-center text-lg md:text-2xl text-slate-300"
>
Learn what works in AI age and for the people around it.
</motion.p>
