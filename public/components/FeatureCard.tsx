...
// keep your DualDirectionSlidingFeatures component as is
const DualDirectionSlidingFeatures: React.FC<DualDirectionSlidingFeaturesProps> = ({
    topCards = [],
    bottomCards = [],
    className = "",
    speed = 30, // fallback speed
  }) => {
...
// ✅ Export a Page component that renders your feature component
export default function FeatureCard() {
    return (
      <DualDirectionSlidingFeatures
        topCards={topRowCards}
        bottomCards={bottomRowCards}
        speed={30} // <-- required for animations
        className="my-slider"
      />
    );
  }
